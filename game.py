...
soundObj = pygame.mixer.Sound('song.mpeg')
soundObj.play()
...
pygame.display.set_caption('Typing speed improving game By-ADP-19EC037')
background = pygame.image.load("front.jpeg")
background = pygame.transform.scale(background, (WIDTH, HEIGHT))  #scale image 
font = pygame.font.Font("comic.ttf", 15)
...
def game_front_screen():
    ...
    if not game_over :
        ...
        draw_text(gameDisplay, "Press a key to begin!", 40, WIDTH / 2, 500)
        draw_text(gameDisplay, "Typing Speed Improving Game!", 54, WIDTH / 2, HEIGHT / 1.5)
    pygame.display.flip()
    waiting = True
    while waiting:
...
while True:
    ...
    character = pygame.image.load("logo.jpeg")
